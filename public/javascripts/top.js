                            ...
                            <div class="border-0 shadow m-4">
                                <div class="card-body d-flex flex-column">
                                    ...
                                    <div class="d-flex justify-content-between mt-auto pt-2 pb-2 border-1 border-dark rounded border-bottom-0 mx-2">
                                        <button class="btn btn-danger w-50 mx-1 hdeleteBtn" data-note-id="${note._id}">
                                            <i class="fa-solid fa-trash fa-lg"></i>
                                        </button>
                                        <button class="btn btn-primary w-50 mx-1 hupdateBtn" type="button" data-bs-toggle="modal" data-bs-target="#staticBackdrop" data-note-id="${note._id}">
